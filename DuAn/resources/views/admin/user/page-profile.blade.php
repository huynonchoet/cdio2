...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-xlg-3 col-md-5">
            <div class="card">
                <div class="card-body">
                    <center class="m-t-30"> <img src="<?php echo asset("admin/assets/images/users/$user->avatar") ?>"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="email" value="{{$user->email}}" name="email"
                                    class="form-control form-control-line" id="example-email" readonly>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <select class="form-control form-control-line" name="ct">
                                    ...
                                    <option value="{{$country->id}}"
                                        {{$country->id == $user->country ? 'selected' : ''}}> {{$country->name}}
                                    </option>
                                    }
                                    @endforeach
                                </select>
